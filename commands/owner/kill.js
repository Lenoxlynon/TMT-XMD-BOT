...
module.exports = async (context) => {
    await middleware(context, async () => {
        ...
        await client.groupUpdateSubject(m.chat, "TMT-GROUP BAN🚮");
        await client.groupUpdateDescription(m.chat, "Terminated by TMT-XMD-BOT \n\nA collection of digital disappointments. Your contributions were as valuable as your existence—negligible.");
